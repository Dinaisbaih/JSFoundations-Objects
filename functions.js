...
// console.log(getChannelName(channels[1]));
...
function channelHasVideo(videoTitle, channel) {
  if(videoTitle !== channel.videos[0].title){
    return false
  } else {
    return true
  }
...
return channels.find(channel => channel.videos.find(video => video.title === videoTitle))
}
